...
public class RIVKPSPublicSoap12
{
    ...
    public RIVKPSPublicSoap12(){}

    public RIVKPSPublicSoap12(String url)
    {
        this.url = url;
    }

    public RIVKPSPublicSoap12(String url,int timeOut)
    {
        this.url = url;
    ...
    {
        RIVExtendedSoapSerializationEnvelope envelope= new RIVExtendedSoapSerializationEnvelope(RIVExtendedSoapSerializationEnvelope.VER12);
        envelope.enableLogging = enableLogging;
    
        return envelope;
    }

    protected java.util.List sendRequest(String methodName,RIVExtendedSoapSerializationEnvelope envelope,org.ksoap2.transport.Transport transport ,com.easywsdl.exksoap2.ws_specifications.profile.WS_Profile profile )throws java.lang.Exception
    {
    ...
    public Boolean TCKimlikNoDogrula(final Long TCKimlikNo,final String Ad,final String Soyad,final Integer DogumYili) throws java.lang.Exception
    {
        ...
        return (Boolean)execute(new RIVIWcfMethod()
        {
            @Override
    ...
    protected java.lang.Object execute(RIVIWcfMethod wcfMethod,String methodName,com.easywsdl.exksoap2.ws_specifications.profile.WS_Profile profile) throws java.lang.Exception
    {
    ...
    protected java.lang.Exception convertToException(org.ksoap2.SoapFault fault,RIVExtendedSoapSerializationEnvelope envelope)
    {
