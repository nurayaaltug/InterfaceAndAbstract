...
class RIVSoapFaultEx extends org.ksoap2.SoapFault
{
    public Object fault;
}
...
public class RIVExtendedSoapSerializationEnvelope extends com.easywsdl.exksoap2.serialization.ExSoapSerializationEnvelope {
    ...
    public static void setDateTimeConverter(RIVDateTimeConverter converter)
    {
        if(converter==null)
        {
            dateTimeConverter = new RIVStandardDateTimeConverter();
        }
        dateTimeConverter=converter;
    }

    public static RIVDateTimeConverter getDateTimeConverter()
    {
        return dateTimeConverter;
    }

    private static RIVDateTimeConverter dateTimeConverter = new RIVStandardDateTimeConverter();
    ...
    private Object createObject(Object soap, Class cl) throws InstantiationException, IllegalAccessException, NoSuchMethodException, InvocationTargetException {
        ...
        Method ctor = obj.getClass().getMethod("loadFromSoap",Object.class,RIVExtendedSoapSerializationEnvelope.class);
    ...
    public static java.lang.Object getXSDType(java.lang.Object param)
    {
        ...
        java.lang.String xmlName=RIVHelper.getKeyByValue(classNames,obj);
        if(xmlName==null)
        {
            return obj;
        }
